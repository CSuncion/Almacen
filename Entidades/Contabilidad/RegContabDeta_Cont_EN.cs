...
namespace Entidades.Contabilidad
{
    public class RegContabDeta_Cont_EN
    {
        ...
        public const string _COrigen = "CodigoOrigen";
        public const string _CFile = "CodigoFile";
        ...
        public const string _CTipoDocumento = "TipoDocumento";
        public const string _FechaVctoDocumento = "FechaVencimiento";
        public const string _CMonedaDocumento = "MonedaDocumento";
        public const string _VentaTipoCambio = "VentaTipoCambio";
        public const string _CodigoCuenta = "CodigoCuentaPcge";
        public const string _CDebeHaber = "DebeHaberRegContabDeta";
        public const string _ImporteSolRegContabDeta = "ImporteSRegContabDeta";
        public const string _ImporteMonedaRegContabDeta = "ImportedRegContabDeta";
        public const string _CIngresoEgreso = "CodigoIngEgr";
        public const string _CCentroCosto = "CodigoCentroCosto";
        ...
        public const string _CEstadoRegContabDeta = "EstadoRegContabdeta";
