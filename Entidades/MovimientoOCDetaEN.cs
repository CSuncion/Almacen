...
namespace Entidades
{
    public class MovimientoOCDetaEN
    {
        ...
        public const string CanRec = "CantidadRecibida";
        public const string CanPen = "CantidadPendiente";
        public const string CanRecVar = "CantidadRecibidaVarios";
        public const string ClaMovICab = "ClaveMovimientoICabe";
        ...
        public string CantidadRecibidaVarios
        {
            get { return _CantidadRecibidaVarios; }
            set { _CantidadRecibidaVarios = value; }
        }

        public string ClaveMovimientoICabe
        {
            get { return _ClaveMovimientoICabe; }
            set { _ClaveMovimientoICabe = value; }
        }
    }
}
