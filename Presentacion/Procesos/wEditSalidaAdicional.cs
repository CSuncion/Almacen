...
{
    public partial class wEditSalidaAdicional : Heredados.MiForm8
    {
        public wEditSalidaAdicional()
        {
            InitializeComponent();
        }
        ...
        {
            //titulo ventana
            //this.Text = this.eOperacion.ToString() + Cadena.Espacios(1) + this.wSalAdi.eTitulo;
        ...
        public void MostrarDatosPersonalDeAlmacen(string pCodigoAlmacen)
        {
            //asignar parametro
        ...
        public void VentanaAdicionar(ProduccionDetaEN pObj)
        {
            ...
            this.MostrarDatosPersonalDeAlmacen(pObj.CodigoAlmacen);            
        ...
        {
            this.InicializaVentana();
            //this.ValoresXDefecto(this.wSalAdi.wParTra.EsProduccionDetaExistente());
        ...
        public void AsignarMovimientoCabe(MovimientoCabeEN pMovCab)
        {
            ...
            //pMovCab.ClaveProduccionDeta= Dgv.ObtenerValorCelda(this.wSalAdi.wParTra.DgvProDet, ProduccionDetaEN.ClaObj);
        ...
        public void Adicionar()
        {
            ...
            //if (Mensaje.DeseasRealizarOperacion(this.wSalAdi.eTitulo) == false) { return; }
            ...
            ////imprimir la nota
            //this.wSalAdi.AccionImprimirNota();
        ...
        public void AdicionarMovimientosDeta()
        {
            ...
            foreach (MovimientoDetaEN xMovDet in this.eLisMovDet)
            {
                ...
                //xMovDet.ClaveProduccionDeta = Dgv.ObtenerValorCelda(this.wSalAdi.wParTra.DgvProDet, ProduccionDetaEN.ClaObj);
        ...
        public void Eliminar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se elimino el ingreso correctamente", this.wSalAdi.eTitulo);
        ...
        public void ListarAlmacenes()
        {
            ...
            //win.eProDetEN = this.wSalAdi.wParTra.EsProduccionDetaExistente();
        ...
        public bool EsAlmacenValido()
        {
            ...
            iAlmEN.ClaveAlmacen = AlmacenRN.ObtenerClaveAlmacen(iAlmEN);
            //ProduccionDetaEN iProDetEN = this.wSalAdi.wParTra.EsProduccionDetaExistente();
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                //Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wSalAdi.eTitulo);
        ...
        public void AccionAgregarItem()
        {
            ...
            //instanciar
            wDetalleSalidaAdicional win = new wDetalleSalidaAdicional();
            win.wEditSalAdi = this;
        ...
        public bool ValidaFechaMovimientoCabeAlAdicionar()
        {
            ...
            {
                //Mensaje.OperacionDenegada(iMovCabEN.Adicionales.Mensaje, this.wSalAdi.eTitulo);
                this.dtpFecMovCab.Focus();
            }
        ...
        //    //asignar parametros
        //    //MovimientoCabeEN iMovCabEN = this.wSalAdi.EsMovimientoCabeExistente();
        ...
        {
            //Generico.CancelarVentanaEditar(this, eOperacion, eMas, this.wSalAdi.eTitulo);
        }
