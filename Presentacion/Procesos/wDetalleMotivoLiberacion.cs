...
{
    public partial class wDetalleMotivoLiberacion : Heredados.MiForm8
    {
        public wDetalleMotivoLiberacion()
        {
            InitializeComponent( );
        }
        ...
        {
            pObj.TipoMotivoLiberacion = this.wMotLib.eTipoMotivo;           
        ...
        public void Adicionar( )
        {
            ...
            this.wMotLib.eClaveDgvMotLib = this.wMotLib.eLisMotLib[this.wMotLib.eLisMotLib.Count - 1].ClaveObjeto;
            this.wMotLib.ActualizarDgvMot( );
            this.wMotLib.MostrarCantidadTotal();
        ...
        {         
            ...
            //adicionar detalle
            this.wMotLib.eLisMotLib.Add(iMotLibEN); 
        }
...
#pragma warning restore CS1522 // Bloque switch vacío
                ...
                case 2:
                    {
                        ...
                        switch (this.wMotLib.eTipoMotivo)
                        {
                            case "MotRep": this.wMotLib.wEdiLibCal.eLibMotEN.DetalleMotivoReproceso = iCampoDetalleMotivo; break;
                            case "MotDon": this.wMotLib.wEdiLibCal.eLibMotEN.DetalleMotivoDonacion = iCampoDetalleMotivo; break;
                            case "MotMue": this.wMotLib.wEdiLibCal.eLibMotEN.DetalleMotivoMuestra = iCampoDetalleMotivo; break;
                            case "MotDes": this.wMotLib.wEdiLibCal.eLibMotEN.DetalleMotivoDesecho = iCampoDetalleMotivo; break;
                        }
                        break;
                    }
            }            
        ...
        public void Modificar( )
        {
            ...
            //Actualizar propietario
            this.wMotLib.eClaveDgvMotLib = this.wMotLib.eLisMotLib[Dgv.ObtenerIndiceRegistroXFranja(this.wMotLib.DgvBot)].ClaveObjeto;
            this.wMotLib.ActualizarDgvMot( );
            this.wMotLib.MostrarCantidadTotal();
        ...
        public void ModificarMotivoLiberacion()
        {
            ...
            MotivoLiberacion iProProTerEN = this.wMotLib.eLisMotLib[Dgv.ObtenerIndiceRegistroXFranja(this.wMotLib.DgvBot)];
            this.AsignarMotivoLiberacion(iProProTerEN);
            
            //modificar el objeto en la lista
            ListaG.Modificar<MotivoLiberacion>(this.wMotLib.eLisMotLib, iProProTerEN, MotivoLiberacion.CodMotLib, iProProTerEN.CodigoMotivoLiberacion);            
        }
        ...
        {
            this.wMotLib.eLisMotLib.RemoveAt( Dgv.ObtenerIndiceRegistroXFranja( this.wMotLib.DgvBot ) );
        }
        ...
        public ItemGEN NuevoItemGVentana()
        {
            ...
            iIteGEN.CodigoTabla = this.wMotLib.eTipoMotivo;
        ...
        public bool EsMotivoValido()
        {
            ...
            string iCodigoItemGFranjaGrilla = Dgv.ObtenerValorCelda(this.wMotLib.DgvBot, MotivoLiberacion.CodMotLib);
            List<MotivoLiberacion> iLisMotLibGrilla = this.wMotLib.eLisMotLib;
        ...
        public void ListarMotivos()
        {
            ...
            win.eIteEN.CodigoTabla = this.wMotLib.eTipoMotivo;
            win.eLisMotLib = this.wMotLib.eLisMotLib;
        ...
        {
            //asignar parametros
            decimal iCantidadTipoMotivo = this.wMotLib.eCantidadMotivo;
            List<MotivoLiberacion> iLisMotLib = this.wMotLib.eLisMotLib;
