...
{
    public partial class wIngresoObservados : Heredados.MiForm8
    {
        public wIngresoObservados()
        {
            InitializeComponent();
        }
        ...
        public string eTitulo = "Ingreso Unidades Observadas";
               
        #endregion

        #region Propietario

        //public wLiberacionDist wLib;
        ...
        public void ValoresXDefecto(LiberacionEN pObj)
        {
            ...
            this.txtCodAlm.Text = "A22";//almacen observados
        }
        ...
        public MovimientoCabeEN ObtenerMovimientoCabeIngresoBD(LiberacionEN pObj)
        {
            ...
            iMovCabEN.ClaveMovimientoCabe = pObj.ClaveIngresoObservadas;
        ...
        //{
        //    if (pObj.ClaveSalidaTransferenciaReproceso == string.Empty)
        //    {
        //        this.eOperacion = Universal.Opera.Adicionar;
        //    }
        //    else
        //    {
        //        if (pObj.CEstadoLiberacion == "0")
        //        {
        ...
        public void ActualizareOperacion(LiberacionEN pObj)
        {
            if (pObj.ClaveIngresoObservadas == string.Empty)
            {
                this.eOperacion = Universal.Opera.Adicionar;
            }
            else
        ...
        {
            this.InicializaVentana(pObj);
            //this.dtpFecMovCab.Text = Dgv.ObtenerValorCelda(this.wLib.wCanRea.wPlaEnc.DgvProCab, EncajadoEN.FecEnc);
            this.MostrarTiposOperacionesIngreso();
            this.MostrarDatosPersonalDeAlmacen();
            this.LLenarMovimientoDetaAlAdicionar(pObj);
            this.MostrarMovimientoDeta();
        ...
        public void LLenarMovimientoDetaDeBaseDatos(LiberacionEN pObj)
        {
            ...
            iMovDetEN.ClaveMovimientoCabe = pObj.ClaveIngresoObservadas;
        ...
        public void LLenarMovimientoDetaAlAdicionar(LiberacionEN pObj)
        {
            ...
            //ejecutar metodo
            this.eLisMovDet = MovimientoDetaRN.ListarMovimientoDetaParaIngresoUnidadesObservados(iLibEN, iMovCabEN);
        }
        ...
        public void Adicionar()
        {
            ...
            Mensaje.OperacionSatisfactoria("Se agrego el ingreso de unidades para observados correctamente", this.eTitulo);

            //actualizar al propietario           
            //this.wLib.eClaveDgvLib = Dgv.ObtenerValorCelda(this.wLib.DgvLib, LiberacionEN.ClaObj);
        ...
        public void Modificar()
        {
            ...
            //mensaje satisfactorio
            //Mensaje.OperacionSatisfactoria("Se modifico el ingreso de unidades para observados correctamente", this.wLib.eTitulo);

            ////actualizar al wLot          
            //this.wLib.eClaveDgvLib = Dgv.ObtenerValorCelda(this.wLib.DgvLib, ProduccionDetaEN.ClaObj);
            //this.wLib.ActualizarVentana();
        ...
        public bool EsPersonalValido()
        {
            ...
            {
                //Mensaje.OperacionDenegada(iPerEN.Adicionales.Mensaje, this.wLib.eTitulo);
        ...
        private void wIngresoObservados_FormClosing(object sender, FormClosingEventArgs e)
        {
