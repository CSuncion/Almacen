...
{
    public partial class wEditLote : Heredados.MiForm8
    {
        public wEditLote()
        {
            InitializeComponent( );
        ...
        public void AsignarLote(LoteEN pObj)
        {
            ...
            pObj.CodigoAlmacen = this.wLot.wDetOrdCom.wEditOrdCom.txtCodAlm.Text.Trim();
            pObj.CodigoExistencia = this.wLot.wDetOrdCom.txtCodExi.Text.Trim();
            pObj.DescripcionExistencia = this.wLot.wDetOrdCom.txtDesExi.Text.Trim();
        ...
        public void Adicionar( )
        {
            ...
            this.wLot.wDetOrdCom.CambiarAtributoSoloLecturaACodigoExistencia();
            this.wLot.wDetOrdCom.MostrarCosto();
        ...
        public void MostrarNuevoCodigoLote()
        {
            ...
            List<LoteEN> iLisLot = this.wLot.wDetOrdCom.eLisLotExi;
        ...
        public void AdicionarLote()
        {
            ...
            //adicionar detalle
            LoteRN.AdicionarLote(this.wLot.wDetOrdCom.eLisLotExi, iLotEN); 
        }
        ...
        public void ModificarLote()
        {
            ...
            //ejecutar metodo
            LoteRN.ModificarLote(this.wLot.wDetOrdCom.eLisLotExi, iLotEN);
        }
        ...
        public void EliminarLote()
        {
            ...
            //ejecutar metodo
            LoteRN.EliminarLote(this.wLot.wDetOrdCom.eLisLotExi, iLotEN);
        }
        ...
        {
            this.wLot.wDetOrdCom.txtCantMovDet.Text = Formato.NumeroDecimal(Dgv.SumarColumna(this.wLot.dgvLot, LoteEN.StoLot), 3);
            this.wLot.wDetOrdCom.txtCanCon.Text = Formato.NumeroDecimal(Dgv.SumarColumna(this.wLot.dgvLot, LoteEN.StoConLot), 3);
        }
        ...
        public void CambiarAtributoSoloLecturaACantidadConversion()
        {
            ...
            this.wLot.wDetOrdCom.AsignarMovimientoDeta(iMovDetEN);
        ...
        public decimal ObtenerCantidad()
        {
            ...
            decimal iFactorConversion = Conversion.ADecimal(this.wLot.wDetOrdCom.txtFacCon.Text, 0);
