...
namespace Presentacion.ProcesosCompras
{
    public partial class wLote : Heredados.MiForm8
    {
        ...
        public wDetalleOrdenCompra wDetOrdCom;
        ...
        {
            this.txtCodExi.Text = wDetOrdCom.txtCodExi.Text;
            this.txtDesExi.Text = wDetOrdCom.txtDesExi.Text;
        }
        ...
        public void MostrarLotes()
        {
            ...
            List<LoteEN> iFuenteDatos = ListaG.Refrescar<LoteEN>(this.wDetOrdCom.eLisLotExi);
        ...
        public void AccionModificarItem()
        {
            ...
            this.eFranjaDgvLot = Dgv.Franja.PorValor;
            TabCtrl.InsertarVentana(this, win);
            win.VentanaModificar(LoteRN.BuscarLoteXClave(Dgv.ObtenerValorCelda(this.dgvLot, LoteEN.ClaObj), this.wDetOrdCom.eLisLotExi));
        }
        ...
        public void AccionQuitarItem()
        {
            ...
            TabCtrl.InsertarVentana(this, win);
            win.VentanaEliminar(LoteRN.BuscarLoteXClave(Dgv.ObtenerValorCelda(this.dgvLot, LoteEN.ClaObj), this.wDetOrdCom.eLisLotExi));
        }
